...
class Disease_Ar extends StatefulWidget {
  const Disease_Ar({Key? key}) : super(key: key);

  @override
  _Disease_ArState createState() => _Disease_ArState();
}

class _Disease_ArState extends State<Disease_Ar> {
  Locale? locale;
